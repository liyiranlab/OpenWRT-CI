...
keywords_to_delete=(
    "xiaomi_ax3600" "xiaomi_ax9000" "xiaomi_ax1800" "glinet" "jdcloud_ax6600" "re-cs-02" "mr7350"
...
if [[ $WRT_CONFIG == *"NMODEM"* ]]; then
	...
	#"CONFIG_MODULE_DEFAULT_kmod-usb-dwc3=n"
	#"CONFIG_DEFAULT_kmod-usb-dwc3-qcom=n"
	#"CONFIG_MODULE_DEFAULT_kmod-usb-dwc3-qcom=n"
	#"CONFIG_DEFAULT_kmod-usb3=n"
	#"CONFIG_MODULE_DEFAULT_kmod-usb3=n"
