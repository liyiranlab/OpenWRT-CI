...
#WRT_THEME: argon
 ...
 #WRT_THEME="kucat"
#修改默认主题
 sed -i "s/luci-theme-aurora/luci-theme-$WRT_THEME/g" $(find ./feeds/luci/collections/ -type f -name "Makefile")
...
echo "CONFIG_PACKAGE_luci-i18n-aurora-config-zh-cn=n" >> ./.config
...
provided_config_lines=(
	...
	"CONFIG_PACKAGE_luci-app-tailscale-community=n"
	...
	"CONFIG_PACKAGEE_kmod-ata-ahci=n"
	"CONFIG_PACKAGEE_kmod-ata-core=n"
	"CONFIG_PACKAGEE_kmod-nvme=n"
	#My内核调整
	"CONFIG_PACKAGEE_kmod-usb-audio=n"
	"CONFIG_PACKAGEE_kmod-usb-core=n"
	"CONFIG_PACKAGEE_kmod-usb-dwc3=n"
	"CONFIG_PACKAGEE_kmod-usb-net=n"
	"CONFIG_PACKAGEE_kmod-usb-net-asix=n"
	"CONFIG_PACKAGEE_kmod-usb-net-asix-ax88179=n"
	"CONFIG_PACKAGEE_kmod-usb-net-cdc-eem=n"
	"CONFIG_PACKAGEE_kmod-usb-net-cdc-ether=n"
	"CONFIG_PACKAGEE_kmod-usb-net-cdc-mbim=n"
	"CONFIG_PACKAGEE_kmod-usb-net-cdc-ncm=n"
	"CONFIG_PACKAGEE_kmod-usb-net-cdc-subset=n"
	"CONFIG_PACKAGEE_kmod-usb-net-huawei-cdc-ncm=n"
	"CONFIG_PACKAGEE_kmod-usb-net-ipheth=n"
	"CONFIG_PACKAGEE_kmod-usb-net-qmi-wwan=n"
	"CONFIG_PACKAGEE_kmod-usb-net-qmi-wwan-fibocom=n"
	"CONFIG_PACKAGEE_kmod-usb-net-qmi-wwan-quectel=n"
	"CONFIG_PACKAGEE_kmod-usb-net-rndis=n"
	"CONFIG_PACKAGEE_kmod-usb-net-rtl8150=n"
	"CONFIG_PACKAGEE_kmod-usb-net-rtl8152=n"
	"CONFIG_PACKAGEE_kmod-usb-net-sierrawireless=n"
	"CONFIG_PACKAGEE_kmod-usb-ohci=n"
	"CONFIG_PACKAGEE_kmod-usb-storage=n"
	"CONFIG_PACKAGEE_kmod-usb-storage-extras=n"
	"CONFIG_PACKAGEE_kmod-usb-storage-uas=n"
	"CONFIG_PACKAGEE_kmod-usb-uhci=n"
	"CONFIG_PACKAGEE_kmod-usb-xhci=n"
	"CONFIG_PACKAGEE_kmod-veth=n"
	"CONFIG_PACKAGEE_kmod-wireguard=n"
	#My组件调整
		...
		"CONFIG_PACKAGE_luci-app-netspeedtest=n"
	 	"CONFIG_PACKAGE_luci-app-mwan3=y"
	  	"CONFIG_PACKAGE_luci-app-gecoosac=y"
			#My内核调整
		"CONFIG_PACKAGEE_kmod-usb-audio=y"
		"CONFIG_PACKAGEE_kmod-usb-core=y"
		"CONFIG_PACKAGEE_kmod-usb-dwc3=y"
		"CONFIG_PACKAGEE_kmod-usb-net=y"
		"CONFIG_PACKAGEE_kmod-usb-net-asix=y"
		"CONFIG_PACKAGEE_kmod-usb-net-asix-ax88179=y"
		"CONFIG_PACKAGEE_kmod-usb-net-cdc-eem=y"
		"CONFIG_PACKAGEE_kmod-usb-net-cdc-ether=y"
		"CONFIG_PACKAGEE_kmod-usb-net-cdc-mbim=y"
		"CONFIG_PACKAGEE_kmod-usb-net-cdc-ncm=y"
		"CONFIG_PACKAGEE_kmod-usb-net-cdc-subset=y"
		"CONFIG_PACKAGEE_kmod-usb-net-huawei-cdc-ncm=y"
		"CONFIG_PACKAGEE_kmod-usb-net-ipheth=y"
		"CONFIG_PACKAGEE_kmod-usb-net-qmi-wwan=y"
		"CONFIG_PACKAGEE_kmod-usb-net-qmi-wwan-fibocom=y"
		"CONFIG_PACKAGEE_kmod-usb-net-qmi-wwan-quectel=y"
		"CONFIG_PACKAGEE_kmod-usb-net-rndis=y"
		"CONFIG_PACKAGEE_kmod-usb-net-rtl8150=y"
		"CONFIG_PACKAGEE_kmod-usb-net-rtl8152=y"
		"CONFIG_PACKAGEE_kmod-usb-net-sierrawireless=y"
		"CONFIG_PACKAGEE_kmod-usb-ohci=y"
		"CONFIG_PACKAGEE_kmod-usb-storage=y"
		"CONFIG_PACKAGEE_kmod-usb-storage-extras=y"
		"CONFIG_PACKAGEE_kmod-usb-storage-uas=y"
		"CONFIG_PACKAGEE_kmod-usb-uhci=y"
		"CONFIG_PACKAGEE_kmod-usb-xhci=y"
		"CONFIG_PACKAGEE_kmod-veth=y"
		"CONFIG_PACKAGEE_kmod-wireguard=y"
		#My组件调整
		"CONFIG_PACKAGE_sfdisk=y"
		"CONFIG_PACKAGE_sgdisk=y"
		"CONFIG_PACKAGE_usbmuxd=y"
